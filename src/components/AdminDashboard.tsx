...
import { ArrowLeft, CalendarClock, Clock, DollarSign, FileEdit, Gavel, LucidePlus, PlayCircle, User, UserPlus, Users } from 'lucide-react';
      ...
      {selectedAuctionId ? (
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <Button variant="ghost" onClick={() => setSelectedAuctionId(null)} className="gap-2">
                ...
                <CardContent className="pb-2">
                  <div className="grid grid-cols-2 gap-2 mb-4">
                    ...
                    <div className="flex flex-col items-center justify-center p-2 bg-muted rounded">
                      ...
                      <span className="text-sm font-medium">{auction.players?.length || 0}</span>
                  ...
                  {auction.status === 'upcoming' ? (
                    <>
                      <Button
                        ...
                        asChild
                      >
                        <Link to={`/admin/edit-auction/${auction.id}`}>
